...
{
    public class DORHistoryMap : EntityTypeConfiguration<DORHistory>
    {
        public DORHistoryMap()
        {
            // Primary Key
            this.HasKey(t => t.HistoryDORId);

            // Properties
            this.Property(t => t.HistoryDORId)
            ...
            this.ToTable("DORHistory");
            this.Property(t => t.HistoryDORId).HasColumnName("HistoryDORId");
