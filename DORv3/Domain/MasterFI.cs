...
namespace DORv3.Domain
{
    ...
    public partial class MasterFI
    {
        ...
        public Nullable<int> tradeyear { get; set; }
        public Nullable<int> trademileage { get; set; }
        public string tradeintent { get; set; }
        public string tradetitle { get; set; }
        public string tradelien { get; set; }
        public Nullable<decimal> tradeacv { get; set; }
        public Nullable<decimal> tradepayoff { get; set; }
        ...
        public string trade2status { get; set; }
