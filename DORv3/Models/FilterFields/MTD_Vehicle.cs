...
{
    public class MTD_Vehicle : MTDFilterField
    {
        public MTD_Vehicle(string fieldName, WhereFilterType whereFilter) : base(fieldName, whereFilter) { }

        public override MTDFilterObj GetFilterObject(object value)
        {
            return new Filter_MTD_VehicleKind(value);
        }
    }
}